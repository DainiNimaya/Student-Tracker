...
import {useNavbarStatus} from '@hooks/useNavbarStatus'
...
const VerticalLayout = props => {
    ...
    const path = window.location.pathname.substr(1, 15)
    const userRole = Cookies.get(config.role)
    // if (!userRole && path === 'student-onboard') setTimeout(() => {
